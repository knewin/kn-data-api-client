...
public abstract class DataRequest<R extends DataRequestInfo, D extends DataInfo> extends RestRequest {
	...
	public final DataResponseInfo<D> request(final R requestInfo, final String url, final CloseableHttpClient httpClient)
		...
		return this.buildResponse(this.post(this.jsonBuilder.toJson(requestInfo), url, httpClient));
	}
	...
	public final DataResponseInfo<D> request(final R requestInfo, final String url) throws DataRequestException {
		return this.buildResponse(this.post(this.jsonBuilder.toJson(requestInfo), url));
	}
